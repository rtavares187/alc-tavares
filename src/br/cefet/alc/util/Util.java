...
public class Util {
	...
	public double[] getDoublePrimitive(List<Double> list){
	...
	public List<Double> getDoublePrimitive(double[] d){
		
		List<Double> ret = new LinkedList<Double>(Arrays.asList(new Double[d.length]));
	...
	public int[] getIntPrimitive(List<Integer> list){
	...
	public List<Integer> getIntPrimitive(int[] d){
		
		List<Integer> ret = new LinkedList<Integer>(Arrays.asList(new Integer[d.length]));
	...
	public void escreveMatrizCSR(CSRMatrix m){
		...
		for(int i = 0; i < m.getN(); i++){
			...
			for(int j = 0; j < m.getN(); j++){
				...
				linha += df.format(m.getValor(i, j)) + "  ";
	...
	public double[][] getVetorTransposto(double[] v){
		
		double[][] vt = new double[v.length][1];
	...
	public boolean equalsZero(double v) {
